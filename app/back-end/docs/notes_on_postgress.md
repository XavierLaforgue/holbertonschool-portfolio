...
- [neon.com/postgresql/postgresql-getting-started/connect-to-postgresql-database](https://neon.com/postgresql/postgresql-getting-started/connect-to-postgresql-database)
- [postgresql.org/docs/8.2/tutorial-createdb.html](https://www.postgresql.org/docs/8.2/tutorial-createdb.html)
